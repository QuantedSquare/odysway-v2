...
#faq
  ...
  La demande peut être faite directement **depuis la page du voyage** concerné, via le bouton “Échanger avec un conseiller” (ou via ce lien : <https://calendly.com/odysway/15min>). Le voyageur choisit lui-même **le créneau d’appel selon ses disponibilités**, pour un échange téléphonique ou en visio. Cet échange permet d’évaluer si le séjour correspond pleinement à ses attentes.
