...
const attachments_get = defineEventHandler(async (event) => {
  ...
  const { data, error } = await supabase.from("date_attachments").select("*").eq("travel_date_id", dateId).order("created_at", { ascending: false });
  if (error) {
...
export { attachments_get as default };
//# sourceMappingURL=attachments.get.mjs.map
