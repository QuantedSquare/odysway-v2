...
const notes_post = defineEventHandler(async (event) => {
  ...
  const { data, error } = await supabase.from("date_notes").insert([{
    travel_date_id: dateId,
    author_email: (bookingUser == null ? void 0 : bookingUser.email) || "unknown",
    author_name: (bookingUser == null ? void 0 : bookingUser.name) || null,
    author_picture: (bookingUser == null ? void 0 : bookingUser.picture) || null,
