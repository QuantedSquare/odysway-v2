import { a as defineEventHandler, u as useRuntimeConfig, q as requireBookingUser, t as getBookingUserOrNull, c as createError, f as readBody, s as supabase, v as logDateActivity } from '../../../../../../../nitro/nitro.mjs';
import 'lru-cache';
import '@unocss/core';
...
const assignDepartureDeal_post = defineEventHandler(async (event) => {
  ...
  const { error: updateError } = await supabase.from("travel_dates").update({ departure_id: dealId }).eq("id", dateId);
  if (updateError) {
...
export { assignDepartureDeal_post as default };
//# sourceMappingURL=assign-departure-deal.post.mjs.map
