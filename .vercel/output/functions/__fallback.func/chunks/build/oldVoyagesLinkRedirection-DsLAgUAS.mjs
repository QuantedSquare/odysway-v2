...
import { bM as Wp, g as qe, X as sa } from './server.mjs';
import 'lru-cache';
import '@unocss/core';
...
const J=Wp(async r=>{let t,o;try{const e=qe(),a=createClient({projectId:e.public.sanity.projectId,dataset:e.public.sanity.dataset,apiVersion:e.public.sanity.apiVersion,useCdn:!0}),i=decodeURIComponent(r.path).split("/"),m=i[i.length-1],s=f(m),c=`*[_type == "voyage" && slug.current == $slug][0]{
      "slug": slug.current
