...
import { u as up, a as Qc, b6 as un, _ as Lu, d as bt, b as gl, V as fi, e as Zn, f as lt, C as fu } from './server.mjs';
import O from 'groq';
...
const X={__name:"ConfirmationContainer",__ssrInlineRender:true,async setup(M){let x$1,h;const T=bt(),J=up(),i=ref(T.query.isoption==="true"),R=ref(T.query.devis==="true"),Y=O`*[_type == "voyage" && slug.current == $slug][0]{
  _id,
  title,
  "slug": slug.current,
  image,
...
//# sourceMappingURL=confirmation-CvTiKlCn.mjs.map
