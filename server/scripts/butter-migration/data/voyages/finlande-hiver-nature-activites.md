::hero-voyage-section
---
image-src: https://cdn.buttercms.com/VyqUkN8tSI2fgngrOGDw
---
#title
...
#component-slot-1
  ...
  #photo-col
    ::::photo-col{col-width="7" image-src="https://cdn.buttercms.com/oacKyPb7RquVVkwCxNCV"}
::::

::::photo-col
---
col-width: "5"
image-src: https://cdn.buttercms.com/4sHw1p1TQazUW2z52MhY
---
::::

::::photo-col{col-width="4" image-src="https://cdn.buttercms.com/poYOkUPRSQu2IKkxps0d"}
::::

::::photo-col
---
col-width: "8"
image-src: https://cdn.buttercms.com/OrTvibbRk6DenrE24Hcx
---
::::

::::photo-col{col-width="5" image-src="https://cdn.buttercms.com/4f38KUSPTAmqvRn7nuEy"}
::::
  :::
...
Tout au long de ce voyage, vous explorerez des sentiers reculés et des paysages à couper le souffle, vous reliant à la magie brute de l'Arctique et aux traditions locales, comme une immersion dans le quotidien des finlandais !
  ...
  :::highlights-row
  ---
  image: https://cdn.buttercms.com/eU3mP6sLQIa3GXLbxoYi
  ---
  ::::highlight-list-item
  ...
  :::
    ...
    :::day-row
    ---
    image: https://cdn.buttercms.com/ofbCTKWnSEef2nmsYg5D
    ---
    #subtitle
    JOUR 1
    ...
    :::day-row
    ---
    image: https://cdn.buttercms.com/Z5KFZArMTtClNh6ztyYy
    ---
    #subtitle
    JOUR 2
    ...
    :::day-row
    ---
    image: https://cdn.buttercms.com/qvlIDbAWTRaiGZtDFLjC
    ---
    #subtitle
    JOUR 3
    ...
    :::day-row
    ---
    image: https://cdn.buttercms.com/79yn5AwNSrqSTAucC6vo
    ---
    #subtitle
    JOUR 4
    ...
    :::day-row
    ---
    image: https://cdn.buttercms.com/RGNBAaFQ7qPiVBx3OPKA
    ---
    #subtitle
    JOUR 5
    ...
    :::day-row
    ---
    image: https://cdn.buttercms.com/y5PfceasQFuIxQoj4ZyI
    ---
    #subtitle
    JOUR 6
    ...
    :::day-row
    ---
    image: https://cdn.buttercms.com/0Ra8RVsQoaUGqrnk4gyc
    ---
    #subtitle
    JOUR 7
    ...
    :::day-row
    ---
    image: https://cdn.buttercms.com/mI3ZSWrfQTKEye7rFQk1
    ---
    #subtitle
    JOUR 8
  ...
  #carousel
    ...
    :::::image-carousel-item
    ---
    image: https://cdn.buttercms.com/YhlJJDNuRXeKRN7thF5k
    ---
    :::::

    :::::image-carousel-item
    ---
    image: https://cdn.buttercms.com/B2RTRaowRiWY4sp142A8
    ---
    :::::
    ::::
  :::
  ...
  #guides
    ::::avatar-list-item
    ---
    avatar: https://cdn.buttercms.com/7Dl6jZ8qRLudPfevhjxW
    ---
    #title
...
#faq
      ...
      **Équipement utile :**
      ...
      La couche de base (à même la peau) : sous-vêtement chaud complet (collant et haut à manche longue).
