::hero-voyage-section
---
image-src: https://cdn.buttercms.com/gzdJu2fbQDi9Pl3h80Jn
---
#title
...
#component-slot-1
  ...
  #photo-col
    ::::photo-col{col-width="7" image-src="https://cdn.buttercms.com/82zgjz7Qb6Cyoqfzux3v"}
::::

::::photo-col
---
col-width: "5"
image-src: https://cdn.buttercms.com/0xwIULbJRuOHcBV61gLk
---
::::

::::photo-col{col-width="4" image-src="https://cdn.buttercms.com/da2hg829QHuUVPQ0O2Z8"}
::::

::::photo-col
---
col-width: "8"
image-src: https://cdn.buttercms.com/e3JcdoXQSuY7oYnBRhpQ
---
::::

::::photo-col{col-width="5" image-src="https://cdn.buttercms.com/QOkJGBaTjunzcLzUFGlN"}
::::

::::photo-col
---
col-width: "7"
image-src: https://cdn.buttercms.com/3tvCI44yQpaOr5gTBV82
---
::::

::::photo-col{col-width="7" image-src="https://cdn.buttercms.com/JlgmelNlQRujtO2P3E9d"}
::::

::::photo-col
---
col-width: "5"
image-src: https://cdn.buttercms.com/Bu5e9O8SaGAf02cMQd8A
---
::::

::::photo-col{col-width="4" image-src="https://cdn.buttercms.com/wHwjSByYTGWO14f9n7Xc"}
::::

::::photo-col
---
col-width: "8"
image-src: https://cdn.buttercms.com/XJEqqPWNRzWwf5nUV9J7
---
::::

::::photo-col{col-width="5" image-src="https://cdn.buttercms.com/y5BsM9gdSUKxj96HthU1"}
::::

::::photo-col
---
col-width: "7"
image-src: https://cdn.buttercms.com/mthXmMwzTyq9OZ98cdR8
---
::::
  :::
...
Laissez-vous porter par cette aventure unique, entre rencontres inoubliables, spiritualité et immersion en pleine nature. Une expérience rare qui célèbre la vie simple et authentique au cœur des vastes terres mongoles.
  ...
  :::highlights-row
  ---
  image: https://cdn.buttercms.com/bjkNrF6ESACxsLUaBgno
  ---
  ::::highlight-list-item
  ...
  :::
    ...
    :::day-row
    ---
    image: https://cdn.buttercms.com/HL7RqcJ7QiK0IagbeOnQ
    ---
    #subtitle
    JOUR 1
    ...
    :::day-row
    ---
    image: https://cdn.buttercms.com/2Tv1s9DESqqd14lfWm1t
    ---
    #subtitle
    JOUR 2
    ...
    :::day-row
    ---
    image: https://cdn.buttercms.com/qpRJoCNQ4maKwfq97MzA
    ---
    #subtitle
    JOURS 3 ET 4
    ...
    :::day-row
    ---
    image: https://cdn.buttercms.com/qX9nS7X9TumrHDEoL4y4
    ---
    #subtitle
    JOUR 5
    ...
    :::day-row
    ---
    image: https://cdn.buttercms.com/e3JcdoXQSuY7oYnBRhpQ
    ---
    #subtitle
    JOURS 6 ET 7
...
En parallèle, des temps libres vous invitent à marcher paisiblement dans la nature, méditer ou simplement contempler les paysages grandioses qui vous entourent. Ces instants, empreints de simplicité, sont l’occasion d’intégrer les expériences vécues et de savourer pleinement la quiétude de cet environnement préservé. Nuits en bivouac sauvage (tipi) avec tout le confort nécessaire (toilettes, douche portable) dans un cadre isolé et naturel.
    ...
    :::day-row
    ---
    image: https://cdn.buttercms.com/tnZ30PDSvqqIruni9glg
    ---
    #subtitle
    JOURS 8 ET 9
    ...
    :::day-row
    ---
    image: https://cdn.buttercms.com/Ya3jV0vWRfGokYwAjUDj
    ---
    #subtitle
    JOUR 10
    ...
    :::day-row
    ---
    image: https://cdn.buttercms.com/mJiQwOD2SGGNi4py8BYh
    ---
    #subtitle
    JOUR 11
    ...
    :::day-row
    ---
    image: https://cdn.buttercms.com/ByCVUSL1QVJPH6uk4oQ0
    ---
    #subtitle
    JOUR 12
  ...
  #carousel
    ...
    :::::image-carousel-item
    ---
    image: https://cdn.buttercms.com/da2hg829QHuUVPQ0O2Z8
    ---
    :::::

    :::::image-carousel-item
    ---
    image: https://cdn.buttercms.com/t0n5cUWyRUSMz3dgNXXp
    ---
    :::::
    ::::
  :::
...
#carousel
  ...
  #carousel-item
    ...
    ::::avis-carousel-item
    ---
    photo: https://cdn.buttercms.com/gkI2ZvkmTNKE1eJhIIwP
    ---
    #title
...
#faq
      ...
      **Total : 2 nuits**
      ...
      • Nuit 8 et 9 (Ikh Tamir, chez une famille nomade)
