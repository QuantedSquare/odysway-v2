::hero-voyage-section
---
image-src: https://cdn.buttercms.com/x01hdUHCS7G5BKtubMLo
---
#title
...
Le cadre naturel dans lequel se déroule ce séjour vous fera découvrir de somptueuses forêts, classées réserve mondiale de la Biosphère par l’UNESCO, idéal pour une expérience pleine de sensations.

  #avatar
    ::::avatar-list-item
    ---
    avatar: https://cdn.buttercms.com/Y6NdwN1SRGcdoSTc2j2A
    avatar-size: "60"
    ---
    #title
  ...
  :::highlights-row
  ---
  image: https://cdn.buttercms.com/EjxhDwGVTq6gRfWfvDCZ
  ---
  ::::highlight-list-item
  ...
  :::
    ...
    :::day-row
    ---
    image: https://cdn.buttercms.com/opkYJFbJTMy6abyVmTFK
    ---
    #subtitle
    JOUR 1
    ...
    :::day-row
    ---
    image: https://cdn.buttercms.com/Vu5dL7KaT2KhbK89jhtK
    ---
    #subtitle
    JOUR 2
    ...
    :::day-row
    ---
    image: https://cdn.buttercms.com/7J0hRtadTaOsEVwEOmD7
    ---
    #subtitle
    JOUR 3
  ...
  #guides
    ::::avatar-list-item
    ---
    avatar: https://cdn.buttercms.com/Tdiq7lKKQeteqlD8fARe
    ---
    #title
    Sandrine
  ...
  ::::avatar-list-item
    ---
    avatar: https://cdn.buttercms.com/MO2OmtjjQTqnBjytg9zn
    ---
    #title
    Manuela
...
#faq
      ...
      -   S’imprégner de l’ambiance des forêts des Vosges du nord le long du circuit d’interprétation du Loosthal (4km – 2h)
