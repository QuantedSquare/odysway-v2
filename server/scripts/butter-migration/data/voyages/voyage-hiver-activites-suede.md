::hero-voyage-section
---
image-src: https://cdn.buttercms.com/n4LPXi1QRuPsqLJDHuAe
---
#title
...
Chaque journée est une nouvelle occasion de se reconnecter à la nature sauvage, tandis que les soirées, confortablement installés dans votre chalet familial, vous savourerez des spécialités locales. Les enfants, guidés par un expert passionné, se transformeront en petits trappeurs, apprenant les gestes ancestraux et observant la faune environnante. Les adultes, tout aussi émerveillés, apprécieront la tranquillité de ces paysages enneigés, où le silence et la pureté de l'air apportent un sentiment de paix. Plus qu'un simple voyage, c'est une expérience enrichissante et ressourçante en totale déconnexion !
  ...
  :::highlights-row
  ---
  image: https://cdn.buttercms.com/52LkaPeBTCCMSZWQJ8US
  ---
  ::::highlight-list-item
  ...
  :::
    ...
    :::day-row
    ---
    image: https://cdn.buttercms.com/QdVAI8h9Stqa3QSLKxFF
    ---
    #subtitle
    JOUR 1
    ...
    :::day-row
    ---
    image: https://cdn.buttercms.com/4scq3FmMRVu7NhFFv6NW
    ---
    #subtitle
    JOUR 2
    ...
    :::day-row
    ---
    image: https://cdn.buttercms.com/9z3Cm1sTT5eBVep69GBB
    ---
    #subtitle
    JOUR 3
    ...
    :::day-row
    ---
    image: https://cdn.buttercms.com/TPGiIeJuTtuQERjevUM5
    ---
    #subtitle
    JOUR 4
    ...
    :::day-row
    ---
    image: https://cdn.buttercms.com/9i1yMgmxRlmVc98ZmbNn
    ---
    #subtitle
    JOUR 5
    ...
    :::day-row
    ---
    image: https://cdn.buttercms.com/uoYUTiA2RRSBqxUE6BBG
    ---
    #subtitle
    JOUR 6
    ...
    :::day-row
    ---
    image: https://cdn.buttercms.com/50CFxN43TL6tFocB3xUM
    ---
    #subtitle
    JOUR 7
    ...
    :::day-row
    ---
    image: https://cdn.buttercms.com/TQcY4SMYTOyD6Y5qZ1qu
    ---
    #subtitle
    JOUR 8
  ...
  #carousel
    ...
    :::::image-carousel-item
    ---
    image: https://cdn.buttercms.com/9qZKpORfR1y3aVTCTEEc
    ---
    :::::

    :::::image-carousel-item
    ---
    image: https://cdn.buttercms.com/vzkuGVdLR4mYiZL5zACI
    ---
    :::::

    :::::image-carousel-item
    ---
    image: https://cdn.buttercms.com/4FGxhmCQ1WEAeBMVnBuY
    ---
    :::::
    ::::
  :::
