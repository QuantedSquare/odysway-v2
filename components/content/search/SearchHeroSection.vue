    ...
    >
      ...
      >
        ...
        <h1
          ...
          class="custom-hero-title"
        >
          {{ destination.periodFilter === 'Toutes périodes' ? 'Découvrez nos voyages de groupe' : `Partez avec un groupe de 8 voyageurs maximum en ${destination.periodFilter.toLowerCase()}` }}
        </h1>
        <h1
          v-else
          class="custom-hero-title"
