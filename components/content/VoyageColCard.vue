  ...
  >
    ...
    >
      ...
      <div>
        ...
        >
          <v-card-text class="py-1 px-1 px-md-3">
            <v-container class="px-1 px-md-3">
              ...
              <v-row>
                <v-col cols="4">
                  <div class="text-grey font-weight-bold text-caption text-md-subtitle-2"> Type </div>
                ...
                >
                  ...
                  <div class="text-grey text-caption text-md-subtitle-2 font-weight-bold">Jours</div>
                </v-col>
                <v-divider
                  inset
                  vertical
                ...
                <v-col
                  ...
                  class="text-right"
                >
                  <div class="text-grey text-caption text-md-subtitle-2 font-weight-bold text-no-wrap"> À partir de </div>
